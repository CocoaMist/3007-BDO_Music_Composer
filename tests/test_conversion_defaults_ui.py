...
class ConversionDefaultsUiTests(unittest.TestCase):
    ...
    def test_new_scores_use_midi_bpm_and_minus_eight_semitones(self) -> None:
        self._run_offscreen(
            """
            import json
            from pathlib import Path
            ...
            assert window.velocity_mode == "layered"
            ...
            assert payload["conversion_settings"]["transpose"] == -8
    ...
    def test_saved_preferences_win_and_legacy_projects_remain_neutral(self) -> None:
        self._run_offscreen(
            ...
            # Projects saved before transpose was persisted must stay at the
            # historical neutral value rather than adopting the new default.
