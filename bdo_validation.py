...
from conversion_settings import VELOCITY_MODE_PRESERVE
...
def _validate_track_articulations(
    ...
    """Validate track-wide and per-note articulation ownership."""
    ...
    if (
        ...
        and (rule is None or int(articulation) not in rule.articulations)
    ):
        issues.append(_issue(
    ...
    elif articulation is not None and item.notes:
        issues.append(_issue(
